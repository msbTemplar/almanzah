"""
Django settings for noaman_manazil project.
...
SECRET_KEY = 'django-insecure-qdyy4s53nh$lxu^=2a=5uh4sy0-g6j4p(2=yd76d0v99&!+!r9'
...
ROOT_URLCONF = 'noaman_manazil.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR /'noaman_manazil_app/templates/noaman_manazil_app/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'noaman_manazil.wsgi.application'
